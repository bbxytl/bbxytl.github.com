...
####项目经验及实习经验
---
#####1. 广州市殷雷软件有限公司&ensp;&ensp;||&ensp;&ensp;**2014.11.27 -- 2015.4.1  &ensp;||&ensp;Qt/C++**
『负责新版本软件数据导出方面的全部工作』
- 提出使用 **Qt/C++** 调用执行**JavaScript**脚本文件消减数据接口与数据库字段的耦合性；
- 提出使用 **NCReport** 报表类库二次开发；短期内使用 **NCReport** 设计器完成报表模板设计；
- 编写软件报表部分（**Qt/C++**）与 **JavaScript** 脚本的**交互通信**；
- 独自解决数据导出显示的问题。

#####2. C/C++代码混淆OBF系统&ensp;&ensp;||&ensp;&ensp;**2013.7-- 2014.04&ensp;||&ensp;MFC/C++** 
『系统实现对C/C++源代码的混淆，减弱源码易读性，增强软件破解难度』
- 基于C/C++语言进行“字符串”、“数组”、“数字”、“标识符”、“控制流”的混淆
- 熟悉了一些代码书写规范和方言，学会编写更加**优雅的代码**
- 加深了**代码安全性**的理解，学会编写更加安全的代码

#####3. 控制流可视化交互式混淆系统&ensp;&ensp;||&ensp;&ensp;**2014.10 -- 至今 **
『系统实现对C源代码的控制流可视化输出，提供交互式界面实现对控制流的更改混淆』
- 基于C语法编写词法分析器，使用Antlr进行C语法分析
- 识别并可视化控制流，提供交互式界面以完成对控制流的更改混淆
- 使用**C# · WinForm**和**MindFusion**和**AvalonDock**框架进行布局处理

#####4. 蚌埠市智海计算机培训公司 · 讲师&ensp;&ensp;||&ensp;&ensp;2013.2 -- 2013.5  &ensp;||&ensp;C
『负责全国计算机等级考试二级C授课』
- 参与了公司二级C的全程授课，对上课学生进行考前的培训工作；
- 授课同时，加深了对于C语法基础语法的理解；应邀参与9月份的四级网络工程师的培训工作。
